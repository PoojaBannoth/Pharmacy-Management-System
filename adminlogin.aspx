<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="Pharmacy_Management_System.adminlogin" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
           <div class="col forms">
               ...
               <div class="heading">
                   <h1>Welcome Admin<img class="imgss" width="50px" src="imgs/adminuser.png" /></h1>
               </div>
